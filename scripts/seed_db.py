            ...
            for i, (_, row) in enumerate(batch.iterrows()):
                ...
                session.execute(
                    ...
                    """),
                    {
                        ...
                        "genres": json.dumps(row["genres"] if isinstance(row["genres"], list) else []),
                        "keywords": json.dumps(row["keywords"] if isinstance(row["keywords"], list) else []),
                        "cast_names": json.dumps(row["cast_names"] if isinstance(row["cast_names"], list) else []),
